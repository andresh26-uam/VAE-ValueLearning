...
N_EXPERT_SAMPLES_PER_OD = 1 if USE_OM is True else 10 if STOCHASTIC else 1# change True only when USE_OM is not True.
...
if __name__ == "__main__":
    ...
    mce_irl = MCEIRL_RoadNetwork(
        ...
        log_interval=3,
        optimizer_kwargs={"lr": 0.2, "weight_decay": 0.00000},

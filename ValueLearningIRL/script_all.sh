...
python train_vsl.py -t 'all' -e roadworld -a 'me' -qp -n=10 -df=1.0 -dfp=1.0 -ename='ADEF_rvsl_' -tn=100 -hz=50 


python train_vsl.py -t 'vsi' -e firefighters -a 'me' -qp -n=10 -df=1.0 -dfp=1.0 -ename='ADEF_fvsi_' -tn=100 -hz=50
python train_vsl.py -t 'all' -e firefighters -a 'me' -qp -n=10 -df=1.0 -dfp=1.0 -ename='ADEF_fvsl_' -tn=100 -hz=50

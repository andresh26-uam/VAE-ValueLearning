...
python train_vsl.py -t 'all' -e roadworld -a 'pc-me' -qp -n=10 -df=1.0 -dfp=1.0 -ename='ZFINAL_rvsl_' -tn=100 -hz=50
...
python train_vsl.py -t 'vsi' -e roadworld -a 'me' -qp -n=10 -df=1.0 -dfp=1.0 -ename='ZFINAL_rvsi_' -tn=100 -hz=50

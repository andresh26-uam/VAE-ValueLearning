...
if __name__ == "__main__":
    ...
    for rep in range(N_EXPERIMENT_REPETITON):
        ...
        learned_rewards_per_round.append(learned_state_action_rewards_per_target)
        tabulated_policies_per_round.append(deepcopy(vsl_algo.learned_policy_per_va))
        ...
        plot_learned_and_expert_rewards(env_real, vsl_algo, learned_state_action_rewards_per_target, vsi_or_vgl='vsi',
        ...
        plot_learned_and_expert_occupancy_measures(env_real, vsl_algo, expert_policy, learned_state_action_rewards_per_target, vsi_or_vgl='vsi',
                                                   target_align_funcs_to_learned_align_funcs=target_align_funcs_to_learned_align_funcs, namefig=f'test{rep}_firefighters_vsi_society')
    ...
    plot_learned_to_expert_policies(expert_policy=expert_policy, vsl_algo=vsl_algo, vsi_or_vgl='vsi', namefig=f'test_expected_over_{N_EXPERIMENT_REPETITON}_firefighters_vsi_society',
                                    learnt_policy=tabulated_policies_per_round, target_align_funcs_to_learned_align_funcs=target_align_funcs_to_learned_align_funcs_per_round)

...
#assumed_grounding = np.zeros((venv.unwrapped.n_states*venv.unwrapped.action_dim, 2))
#assumed_grounding[:,0] = np.reshape(venv.unwrapped.reward_matrix_per_align_func(profiles[-1]), (venv.unwrapped.n_states*venv.unwrapped.action_dim))
#assumed_grounding[:,1] = np.reshape(venv.unwrapped.reward_matrix_per_align_func(profiles[0]),(venv.unwrapped.n_states*venv.unwrapped.action_dim))

...
/**
 * Entity Class representing a "less than" operator (<) in the ACT.
 * @author Software Architecture Research Group
 *
 */
public class LessThanAttributeComparisonOperator extends AttributeOperator {

    public LessThanAttributeComparisonOperator(Attribute a1, Attribute a2) {
        super(a1, a2);
    }
    ...
    public AttributeCondition copy() {
        ...
        return new LessThanAttributeComparisonOperator(copy[0], copy[1]);
    }
